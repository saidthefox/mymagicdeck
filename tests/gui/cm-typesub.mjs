...
await p.evaluate(()=>{ const it=[...document.querySelectorAll('#cm-picker .cm-picker-item')].find(e=>e.textContent==='Creature'); it&&(it.dispatchEvent(new PointerEvent('pointerdown',{bubbles:true})),it.dispatchEvent(new PointerEvent('pointerup',{bubbles:true}))); });
...
await p.evaluate(()=>{ const it=[...document.querySelectorAll('#cm-picker .cm-picker-item')].find(e=>e.textContent==='Angel'); it&&(it.dispatchEvent(new PointerEvent('pointerdown',{bubbles:true})),it.dispatchEvent(new PointerEvent('pointerup',{bubbles:true}))); });
